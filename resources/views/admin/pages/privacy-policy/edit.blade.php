...
@section('title','تعديل صفحة سياسة الخصوصية ')
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.privacy-policy.update',$privacy_policy -> id)}}"
                                              method="POST"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($privacy_policy -> active == 1)checked @endif/>
                                            ...
                                            <div class="row" >
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea id="ckeditor" name="description" value="description">{{$privacy_policy->description}} </textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="seo_title"
                                                                   ...
                                                                   value="{{$privacy_policy-> seo_title}}"
                                                                   name="seo_title">
                                                            @error("seo_title")
                                                            <span class="text-danger"> {{$message}}</span>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                   ...
                                                                   value="{{$privacy_policy-> seo_description}}"
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <textarea multiple name="seo_keyword" placeholder="بنشر, تبديل تواير, كهربائي, ميكانيكي" class="form-control" value="{{$privacy_policy-> seo_keyword}}" >{{$privacy_policy-> seo_keyword}}</textarea>
                                                            </div>
                                                            @error("seo_keyword")
                                                            <span class="text-danger"> {{$message}}</span>
                                                            @enderror
